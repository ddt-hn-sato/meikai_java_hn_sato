...
public class ensyu06_06 {
	...
	public static void main(String[] args) {
		...
		for(indexNumber = 0, maxScores = 0, minimumScores = 0;indexNumber < intArray.length; indexNumber++) {
			...
			//ここまでの要素の平均を求める
			averageScores = (double)sumScores / ((double)indexNumber + 1);
